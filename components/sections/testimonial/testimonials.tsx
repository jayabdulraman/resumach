  ...
  [
    {
      name: "A. Rehman",
      quote:
        "Hey Amruth, I have loved your JobFit Website. Thank you so much for making this kind of thing.",
    },
    {
      name: "S. Innocent",
      quote:
        "First of all, I appreciate your effort for making JobFit a free tool for the community. Very much better than many premium resume builder...",
    },
    {
      name: "M. Fritza",
      quote:
  ...
  <section id="testimonials" className="container relative">
    <div className="space-y-6 text-center">
      ...
      <p className="mx-auto max-w-2xl text-gray-600 leading-relaxed">
          I always love to hear from the users of JobFit with feedback or support. Here are
