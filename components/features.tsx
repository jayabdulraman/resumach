...
import { Clock, FileText, Layout, Shield, UserCheck, Search } from 'lucide-react';
...
const FeaturesSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: "JobFit AI analyzes job descriptions and optimizes your resume accordingly, increasing your chances of landing an interview."
    },
    {
      icon: Layout,
    ...
    },
    {
      ...
      description: "Your personal information is anonymised, making sure your privacy is protected and information is not shared with the generative AI tools we work with."
    },
    {
      icon: UserCheck,
